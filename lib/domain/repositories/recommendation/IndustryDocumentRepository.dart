...
class DocumentRepository {
  ...
  Future<void> uploadDocument({
    ...
    if (documentName != null) request.fields['name'] = documentName;
    request.fields['code'] = documentCode;
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      throw Exception('Failed to upload document: ${response.statusCode} - $body');
    }
  }
