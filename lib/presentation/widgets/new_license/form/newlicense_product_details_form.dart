...
class NewlicenseProductdetailsForm extends StatefulWidget {
  final Map<String, dynamic> initialData;
  final Function(Map<String, dynamic>) onChanged;
  final Function(bool) onValidationChanged;

  const NewlicenseProductdetailsForm({
    Key? key,
  ...
  @override
  State<NewlicenseProductdetailsForm> createState() => _newlicenseproductdetailsform();
}

class _newlicenseproductdetailsform extends State<NewlicenseProductdetailsForm> {
